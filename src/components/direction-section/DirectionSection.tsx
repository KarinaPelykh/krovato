  ...
  return (
    <section className="py-[60px] desktop:py-[70px] bg-white">
      <div className="container">
        ...
        <ul className="grid  gap-[30px] desktop:grid-rows-4 desktop:grid-cols-2 desktop:gap-y-2.5 desktop:gap-x-[30px] mb-10">
          <li className="flex gap-2.5 w-full desktop:grow-0	 desktop:h-[56px] desktop:shrink-0">
            <Icon name="pointer" className="size-8" />
          ...
          <li className="flex gap-2.5 desktop:row-start-2 desktop:row-end-4 desktop:h-[140px] desktop:shrink-0">
            <Icon name="pointer" className="size-8" />
          ...
          <li className="flex gap-2.5  desktop:row-start-4 desktop:row-end-5 desktop:h-[84px] desktop:shrink-0">
            <Icon name="pointer" className="size-8" />
            <p className=" w-full mobile:min-w-[358px]  desktop:w-[578px]  text-xl text-black font-semibold">
        ...
        <Button className="bg-yellow text-white rounded-lg p-[13px] w-full flex justify-center items-center tablet:mx-auto gap-[15px] tablet:w-[410px]">
          <Icon name="map" />
          Прокласти маршрут
        </Button>
      </div>
