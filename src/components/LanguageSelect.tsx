  ...
  return (
    <div
      ...
      <div className='flex'>
        ...
        <Icon
          className='fill-gray rotate-180'
          name='select'
        />
      </div>
      ...
      {isOpen && (
        <div
          ...
          className='py-2.5 h-[76px] px-1.5 absolute top-0 left-0 bg-white rounded-xs cursor-pointer
            justify-center shadow-1xl flex flex-col gap-2.5'>
          <button
            className={clsx(
