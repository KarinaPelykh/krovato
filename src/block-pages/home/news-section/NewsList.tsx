        ...
        {list.map(i => (
          <li
            ...
            <img
              src='/furniture.webp'
              alt='news'
              className='rounded-xs transition-all ease-[cubic-bezier(0.645, 0.045, 0.355, 1)]
                duration-500 desktop:group-hover:object-cover desktop:group-hover:h-[454px]
                desktop:group-hover:w-[410px] desktop:w-[410px] desktop:h-[270px] h-auto w-full
                object-cover block mobile:h-[270px]'
            />

            <div
              className='transition-all duration-500 ease-[cubic-bezier(0.645, 0.045, 0.355, 1)]
                rounded-xs rounded-t-none p-[30px]'>
