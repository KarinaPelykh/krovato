...
export const DirectionSection = () => (
  <section className='py-17 desktop:py-18 bg-white'>
    <div className='container'>
      <Headings className='desktop:text-center mb-10'>
      ...
      <ul
        ...
        <li className='flex gap-2.5 w-full desktop:grow-0 desktop:h-[56px] desktop:shrink-0'>
          <Icon
            ...
            className='size-8'
          />
          <p className='w-full mobile:min-w-[358px] desktop:w-[565px] text-xl font-semibold'>
        ...
        <li
          ...
          <Icon
            ...
            className='size-8'
          />
          <p className='w-full mobile:min-w-[358px] desktop:w-[578px] text-xl font-semibold'>
            Від ст. м. «Академмістечко» — маршрутне таксі № 56, 56Д у напрямку
            Кільцевої дороги, повз завод «Електронмаш», зуп.
            «Литвиненко-Вольгемут», минаючи поворот на Софіївську Борщагівку та
            Вишневе, зупинка одразу за Жулянським мостом, виходити на зупинці
            «Путопровід».
          </p>
        </li>
        <li
